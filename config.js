...
const GAME_CONFIG = {
    ...
    NIGHT_ROLE_BRIEFS: {
        Doctor: {
            motivation: 'Ты последний человек в городе, кто еще спорит со смертью по рабочим вопросам. Пока остальные пишут некрологи, ты возвращаешь людей в расписание.',
        ...
        Bodyguard: {
            motivation: 'Ты не веришь в справедливость, ты веришь в броню и плохие решения ради хороших людей. Если беда стучится в дверь, открывать будешь ты.',
        ...
        MafiaBoss: {
            motivation: 'У тебя лед в голосе и бухгалтерия из чужих ошибок. Ты не повышаешь тон, ты просто вычеркиваешь фамилии и называешь это порядком.',
        ...
        Mafia: {
            motivation: 'Пока город играет в честность, ты играешь в результат. Ночь для тебя как смена в офисе, только KPI измеряется количеством молчаливых стульев за столом.',
        ...
        Maniac: {
            motivation: 'Тебе не нужна победа команды, тебе нужна тишина после паники. Чем меньше в городе людей, тем больше в нем твоего личного комфорта.',
        ...
        Mistress: {
            motivation: 'Ты не стреляешь и не лечишь, ты аккуратно двигаешь чужую уверенность на полтона в сторону катастрофы. Один шепот, и правда уже в макияже.',
        ...
        Detective: {
            motivation: 'Ты единственный, кто приходит на этот праздник паранойи с фонариком и блокнотом. Пока все кричат, ты собираешь факты и режешь ложь по швам.',
