...
const GAME_CONFIG = {
     ...
     */
    NIGHT_ROLE_BRIEFS: {
        Doctor: 'Пока город учится терять людей, ты учишь его передумывать умирать: каждую ночь вытаскиваешь одного живого из чужого прицела, но подряд одного и того же не прикрываешь.',
        Bodyguard: 'Ты работаешь не словами, а корпусом: выбираешь, кого закрыть собой этой ночью, и если прилетает в него, боль забираешь первым.',
        MafiaBoss: 'Ты не споришь, ты списываешь людей в расход: когда рядовой мафии не осталось, именно ты ставишь финальную подпись под ночным выстрелом.',
        Mafia: 'Пока мирные обсуждают мораль, ты правишь статистику: ночью выбираешь, кто не доживет до сводки, а иногда пропускаешь ход, чтобы запутать охоту на себя.',
        Maniac: 'Тебе не нужен лагерь и флаг, тебе нужна тишина после крика: каждую ночь выбираешь жертву и режешь дистанцию до соло-финала без права паса.',
        Mistress: 'Ты убиваешь не людей, а уверенность: выбираешь цель, и если Детектив полезет именно туда, он унесет с собой красиво упакованную ложь.',
        Detective: 'Пока стол тонет в версиях, ты режешь туман фактами: каждую ночь проверяешь одного живого, но себя и уже вскрытые досье не трогаешь.'
    },
