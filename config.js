...
const GAME_CONFIG = {
    ...
    /**
     * АТМОСФЕРНЫЕ БРИФЫ ДЛЯ НОЧНЫХ РОЛЕЙ
     * Небольшая подсказка ведущему: мотивация, способности и цель роли.
     */
    NIGHT_ROLE_BRIEFS: {
        Doctor: {
            motivation: 'Ты давно понял: в этом городе выживают не невинные, а те, кого успели вытащить вовремя.',
            abilities: 'Каждую ночь выбираешь одного живого и прикрываешь его от смерти. Подряд одного и того же спасать нельзя.',
            goal: 'Удержать город на плаву и довести мирных до победы.'
        },
        Bodyguard: {
            motivation: 'Пока другие спорят, ты просто встаешь между пулей и тем, кто должен увидеть рассвет.',
            abilities: 'Выбираешь одного игрока и прикрываешь его собой. Если удар идет в цель, ты принимаешь его первым.',
            goal: 'Сорвать ночные убийства и сохранить ключевых союзников в игре.'
        },
        MafiaBoss: {
            motivation: 'Ты не кричишь и не споришь. Ты подписываешь чужие судьбы коротким кивком.',
            abilities: 'Когда обычной мафии не осталось, именно ты делаешь ночной выстрел и выбираешь, кто исчезнет к утру.',
            goal: 'Дожать стол до контроля мафии и оставить город без сопротивления.'
        },
        Mafia: {
            motivation: 'Для тебя ночь - это время работы. Пока город спит, ты сокращаешь чужие шансы на утро.',
            abilities: 'Выбираешь цель на убийство. Можешь пропустить ход, если нужно сбить темп и подозрения.',
            goal: 'Уменьшить число мирных и довести партию до преимущества мафии.'
        },
        Maniac: {
            motivation: 'Тебе не нужны фракции и союзы. Нужен только страх, который останется после твоей ночи.',
            abilities: 'Каждую ночь выбираешь жертву и бьешь без права пропуска.',
            goal: 'Пережить всех и остаться единственным, кто диктует финал.'
        },
        Mistress: {
            motivation: 'Ты побеждаешь не силой, а точным шепотом в нужное ухо в нужный момент.',
            abilities: 'Выбираешь цель. Если Детектив проверит ее этой ночью, он получит намеренно искаженный ответ.',
            goal: 'Ломать логику расследований и вести стол туда, где тебе выгодно.'
        },
        Detective: {
            motivation: 'Ты здесь, чтобы в хаосе ночи собрать факты и превратить слухи в доказательства.',
            abilities: 'Проверяешь одного живого игрока за ночь, но не можешь проверять себя и повторять ту же цель.',
            goal: 'Найти угрозы, направить дневное голосование и очистить город.'
        }
    },
...
const ConfigUtils = {
    ...
    /**
     * Получить атмосферный бриф роли для ведущего
     */
    getNightRoleBrief(roleName) {
        return GAME_CONFIG.NIGHT_ROLE_BRIEFS[roleName] || null;
    },
